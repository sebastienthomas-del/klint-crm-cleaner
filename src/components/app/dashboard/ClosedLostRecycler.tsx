...
const ClosedLostRecycler = () => {
  const { closedLostDeals, stats, isLoading } = useSalesOpsAgent();
        ...
        {isLoading ? (
          ...
          <div className="text-center py-10 text-muted-foreground space-y-3">
            <div className="w-14 h-14 rounded-2xl bg-success/10 flex items-center justify-center mx-auto">
              <Sparkles className="w-7 h-7 text-success opacity-60" />
            </div>
            <div>
              <p className="font-medium text-foreground">Détection en cours de développement</p>
              <p className="text-sm mt-1 max-w-xs mx-auto">
                Le recyclage des opportunités nécessite la synchronisation des deals HubSpot — disponible prochainement.
              </p>
            </div>
