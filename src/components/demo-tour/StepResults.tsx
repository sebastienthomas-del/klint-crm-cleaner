    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-muted-foreground">
          Voici ce que l'agent Klea a accompli sur votre base, en autonomie.
        </p>
      </div>
      ...
      >
        <h3 className="font-display text-2xl font-bold mb-3">Prêt à activer Klea sur votre base ?</h3>
