...
export const championMoves: ChampionMove[] = [
  ...
  },
  {
    ...
    suggestedHook: 'Alexandre, CRO chez InnovTech - quelle évolution ! Chez OldCorp vous aviez doublé votre taux de réactivation avec Klea...'
  },
  {
    id: 'ch-3',
    contactId: 'ch-c3',
...
export const highValueTargets: HighValueTarget[] = [
  {
    ...
    suggestedHook: 'Les CEOs tech qui ont adopté Klea économisent en moyenne 15h/semaine sur la maintenance CRM - 15 min pour en discuter ?'
  },
  {
    id: 'hvt-2',
    firstName: 'Isabelle',
