...
import { Pickaxe, Mail, Lock, User, Building, Eye, EyeOff, ArrowRight, Sparkles } from 'lucide-react';
...
const Auth = () => {
  ...
  const handleGoogleAuth = async () => {
    ...
    if (error) toast.error(error.message || 'Erreur Google sign-in.');
  };
    ...
    <div className="min-h-screen relative flex items-center justify-center p-4">
      ...
      >
        <Link to="/" className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="font-display text-2xl font-bold text-primary-foreground">Kleant</span>
        </Link>
            ...
            <TabsContent value="login">
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? 'Connexion...' : t('auth.loginButton')}
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <Button
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? 'Création...' : t('auth.signupButton')}
                  <ArrowRight className="w-4 h-4" />
                </Button>
