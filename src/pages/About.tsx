...
const About = () => {
  ...
  const milestones = [
    { year: '2023', title: 'L\'idée', description: 'Naissance de Kleant suite à notre frustration de Sales Ops face aux CRM mal entretenus.' },
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="font-display text-4xl lg:text-5xl font-bold mb-6">
              À propos de <span className="gradient-text">Kleant</span>
            </h1>
            <p className="text-lg text-muted-foreground">
              Nous avons créé Kleant parce que nous avons vécu la frustration d'un CRM pollué. 
